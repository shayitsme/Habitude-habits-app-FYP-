...
class Habit6FormWidget extends StatefulWidget {
  final String title;
  ...
  @override
  State<Habit6FormWidget> createState() => _Habit6FormWidgetState();
}

class _Habit6FormWidgetState extends State<Habit6FormWidget> {
